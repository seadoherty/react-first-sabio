    ...
    return (
      <>
        ...
        <main role="main">
          ...
          <Route path="/friends/:id(\d+)/edit" exact={true} render={(props)=> <AddFriends {...this.props}/> }/>
          ...
          <Route path="/companies/add" exact={true} render={(props)=> <AddCompanies {...this.props}/> }/>
          <Route path="/jobs" exact={true} render={(props)=> <Jobs {...this.props}/> }/>
          <Route path="/jobs/add" exact={true} render={(props)=> <AddJobs {...this.props}/> }/>
          ...
          <Route path="/cars" exact={true} render={(props)=> <Cars {...this.props}/> }/>
        </main>
