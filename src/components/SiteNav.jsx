    ...
    return (
      ...
      <div className="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul className="navbar-nav mr-auto">     
          ...
          <li className="nav-item"> <NavLink to="/productform" className="nav-link"> Product Form </NavLink> </li>
          <li className="nav-item"> <NavLink to="/cars" className="nav-link"> Cars </NavLink> </li>
        </ul>
      </div>
